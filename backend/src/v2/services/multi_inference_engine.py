...
class MultiInferenceEngine:
    ...
    def _get_agent_prompt(self, agent_name: str, inference_num: int, previous_context: Dict[str, Any] = None) -> str:
        ...
        prompts = {
            ...
            "damage_detector": "Analyze the garment and identify if damaged (yes/no), Damage-type (with location as as small sentence). Return null as damage_type, if no damage found. ",
