    ...
    updateAgentResults(agentId, results) {
        ...
        switch (agentId) {
            case 'initial_classifier':
                this.updateResultItem('initial-type', 'Type', results.type || results.item_type || results.clothing_type);
                ...
                this.updateResultItem('initial-neckline', 'Neckline', results.neckline || results.neckline_style);
                this.updateResultItem('initial-sleeve', 'Sleeve', results.sleeve || results.sleeve_length);
                this.updateResultItem('initial-closure', 'Closure', results.closure || results.closure_type);
                break;
            ...
            case 'damage_detector':
                this.updateResultItem('damage-status', 'Damaged', results.is_damaged || results.damaged || (results.has_damage ? 'Yes' : 'No'));
                this.updateResultItem('damage-type', 'Damage Type', results.damage_type);
                break;
                ...
                if (resultsContainer) {
                    ...
                    if (agentId === 'initial_classifier') {
                        resultsContainer.innerHTML = `
                            ...
                            <div class="result-item" id="initial-neckline">Neckline: --</div>
                            <div class="result-item" id="initial-sleeve">Sleeve: --</div>
                            <div class="result-item" id="initial-closure">Closure: --</div>
                        `;
                        ...
                        resultsContainer.innerHTML = `
                            <div class="result-item" id="damage-status">Damaged: --</div>
                            <div class="result-item" id="damage-type">Damage Type: --</div>
                        `;
